...
train_df = pd.read_csv("/content/drive/MyDrive/TrOCR/train/train.csv")

# Rename columns
train_df.rename(columns={'file-name': 'file_name'}, inplace=True)

valid_df = pd.read_csv(f"/content/drive/MyDrive/TrOCR/valid/valid.csv")
...
train_dataset = IAMDataset(root_dir='/content/drive/MyDrive/TrOCR/train',
                           df=train_df,
                           processor=processor)
eval_dataset = IAMDataset(root_dir='/content/drive/MyDrive/TrOCR/valid',
                           df=valid_df,
                           processor=processor)
